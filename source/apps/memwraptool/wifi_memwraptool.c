...
static int memwraptool_event_webconfig_set_data(wifi_app_t *apps, void *arg,
...
static int handle_memwraptool_webconfig_event(wifi_app_t *apps, wifi_event_subtype_t sub_type,
    void *data)
{
    switch (sub_type) {
